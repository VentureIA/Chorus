    ...
    <div className="flex h-full flex-col border-l border-border bg-muted">
      ...
      <div className="flex-1 overflow-auto p-3">
        ...
        <div className="mb-4">
          ...
          <div className="text-xs text-foreground">{commit.author_name}</div>
        ...
        <div className="mb-4 flex gap-2">
          {onCreateBranchAtCommit && (
            <button
              ...
              className="flex items-center gap-1.5 rounded border border-border bg-card px-2 py-1 text-xs text-foreground transition-colors hover:bg-border/50"
            >
              <GitBranch size={12} />
              Create branch
            </button>
                  ...
                  <div className="space-y-0.5">
                    {dirFiles.map((file) => {
                      ...
                      return (
                        <div
                          key={file.path}
                          className="flex items-center gap-2 rounded px-1 py-0.5 hover:bg-card/30"
                        >
